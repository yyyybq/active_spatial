...
# =============================================================================
# Cambrian-S 7-GPU Training with Active Spatial V2 Dataset
# =============================================================================
# - 6 GPUs (0-5) for training, 1 GPU (6) for rendering
# - Uses HF rollout (not vLLM) since Cambrian-S is not supported by vLLM
# - CambrianForCausalLMAdapter wraps the model for GPU-compatible forward
# - CambrianHFRollout handles multimodal generation with pixel_values
# - CambrianRolloutManager handles <image> → IMAGE_TOKEN_INDEX expansion
# =============================================================================
...
# Set this to your Cambrian-S final weights path
...
if [ "$CAMBRIAN_MODEL_PATH" = "/path/to/cambrian-s-weights" ]; then
    ...
    echo "  e.g.: export CAMBRIAN_MODEL_PATH=/scratch/by2593/project/weights/cambrian-s"
    exit 1
fi
...
# Run PPO training with Cambrian-S
